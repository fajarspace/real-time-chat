    ...
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
      ...
      <div class="block lg:hidden pr-4">
        <button id="nav-toggle"
          class="flex items-center p-1 text-blue-800 hover:text-gray-900 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
  ...
  <div class="pt-10">
    <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
      ...
      <div class="w-full md:w-3/5 py-6 text-center">
        <img class="w-full md:w-4/5 z-50" src="static/img/main/stars.svg" />
      </div>
    </div>
  </div>
    ...
    <div class="container max-w-5xl mx-auto m-8">
      ...
      <div class="flex flex-wrap">
        <div class="w-5/6 sm:w-1/2 p-6">
          ...
          <p class="text-gray-500 mb-8 text-2xl">
            Gunakan ponsel, tablet, atau komputer untuk mengakses pesan Kamu dimana saja, kapan saja
          </p>
        </div>
      ...
      <div class="flex flex-wrap flex-col-reverse sm:flex-row">
        <div class="w-full sm:w-1/2 p-6 mt-6">
          <img width="80%" src="static/img/main/connected-world.svg" alt="">
        </div>
        <div class="w-full sm:w-1/2 p-6 mt-6">
          <div class="align-middle">
            ...
            <p class="text-gray-500 mb-8 text-2xl">
              Kirim pesan secara langsung (Live) tanpa takut pesan kamu tidak terkirim
              <br />
              <br />
              <!-- Images from:
    ...
    <div class="container mx-auto px-8">
      <div class="w-full flex flex-col md:flex-row py-6">
        ...
        <div class="flex-1">
          ...
          <ul class="list-reset mb-6">
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a href="#" class="no-underline hover:underline text-gray-800 hover:text-blue-500">PHP</a>
            </li>
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a href="#" class="no-underline hover:underline text-gray-800 hover:text-blue-500">MYSQL</a>
            </li>
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a href="#" class="no-underline hover:underline text-gray-800 hover:text-blue-500">TAILWIND CSS</a>
            </li>
          </ul>
          <p class="uppercase text-gray-500 md:mb-6">Tools</p>
          <ul class="list-reset mb-6">
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a href="#" class="no-underline hover:underline text-gray-800 hover:text-blue-500">Visual Studio Code</a>
            </li>
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a href="#" class="no-underline hover:underline text-gray-800 hover:text-blue-500">XAMPP</a>
            </li>
        ...
        <div class="flex-1">
          ...
          <ul class="list-reset mb-6">
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a href="#" class="no-underline hover:underline text-gray-800 hover:text-blue-500">FAJAR AGUNG NUGROHO</a>
            </li>
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a href="#" class="no-underline hover:underline text-gray-800 hover:text-blue-500">BERLIANA NOVIANSYAH</a>
            </li>
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a href="#" class="no-underline hover:underline text-gray-800 hover:text-blue-500">ADITYA BANI ISRO</a>
            </li>
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a href="#" class="no-underline hover:underline text-gray-800 hover:text-blue-500">ALFHIN CHORRY
                AGNESHA</a>
            </li>
          </ul>
        </div>
